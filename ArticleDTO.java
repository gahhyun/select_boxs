...
public class ArticleDTO {
	...
	public List<String> getBaseballArray() {
		return baseballArray;
	}

	public void setBaseballArray(List<String> baseballArray) {
		this.baseballArray = baseballArray;
	}
	...
	public String toString() {
		return "ArticleDTO [article_no=" + article_no + ", user_no=" + user_no + ", article_index_no="
				...
				+ report_count + ", baseball=" + baseball + ", sex=" + sex + ", category=" + category + ", userDTO="
				+ userDTO + "]";
	}
